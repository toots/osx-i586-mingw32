...
static inline rtx gen_sse3_monitor64_si                    (rtx, rtx, rtx);
static inline rtx
gen_sse3_monitor64_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_sse3_monitor64_di                    (rtx, rtx, rtx);
static inline rtx
gen_sse3_monitor64_di(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
...
static inline rtx gen_isinfxf2                             (rtx, rtx);
static inline rtx
gen_isinfxf2(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_isinfsf2                             (rtx, rtx);
static inline rtx
gen_isinfsf2(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_isinfdf2                             (rtx, rtx);
static inline rtx
gen_isinfdf2(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
